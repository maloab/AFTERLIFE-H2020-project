...
Storage or further sludge treatment is not jet considered."));
  ...
  protected
    ...
    //fixed
    parameter Real[n] a = {0.0014, 0.003, 5.36, 21, 1.7};
  ...
  model UltrafilterA
    ...
    parameter Real Dch = 1 "Diffusivity coefficient";
    parameter Real Dpr = 0.1 "Diffusivity coefficient";
    parameter Real Dli = 0.1 "Diffusivity coefficient";
    parameter Real Dsu = 0 "Diffusivity coefficient";
    parameter Real Daa = 0.1 "Diffusivity coefficient";
    parameter Real Dfa = 0.1 "Diffusivity coefficient";
    parameter Real Dch4 = 0.1 "Diffusivity coefficient";
    parameter Real Dpro = 0.1 "Diffusivity coefficient";
    parameter Real Dac = 0.1 "Diffusivity coefficient";
    parameter Real Dh2 = 1 "Diffusivity coefficient";
    parameter Real DI = 0 "Diffusivity coefficient";
    parameter Real DSsu = 0.135 "Diffusivity coefficient";
    parameter Real DSaa = 0.135 "Diffusivity coefficient";
    parameter Real DSfa = 0.135 "Diffusivity coefficient";
    parameter Real DSva = 0.135 "Diffusivity coefficient";
    parameter Real DSbu = 0.135 "Diffusivity coefficient";
    parameter Real DSpro = 0.135 "Diffusivity coefficient";
    parameter Real DSac = 0.135 "Diffusivity coefficient";
    parameter Real DSh2 = 1 "Diffusivity coefficient";
    parameter Real DSch4 = 1 "Diffusivity coefficient";
    parameter Real DPHA = 0 "Diffusivity coefficient";
    parameter Real DXPHA = 0.1 "Diffusivity coefficient";
    parameter Real DXs = 0.1 "Diffusivity coefficient";
    ...
    Real q1(unit = "m3/d") "Wastewater volumetric flow rate";
    Real q3(unit = "m3/d") "Retained volumetric flow rate";
    Real q4(unit = "m3/d") "Permeate volumetric flow rate";
    //Flux through membrane
...
//PTm = if noEvent((q4 + Va) / 3600 / 24 * Vis * Rt > 5e5) then 5e5 else (q4 + Va) / 3600 / 24 * Vis * Rt;
  ...
  model AD_CO2
    ...
    parameter Real V = 5.36 "Volume reactor m3";
...
// Particulate fraction
    ...
    der(Xaa) = ((Vdot_f / V * (Xaaf/1000 - Xaa/1000) + Y_aa * R6 - R14))+1.5 "Aminoacids";
//Xsu = 1000;
//  Xaa = 6000;
//  Xfa = 6000;
    der(Xfa) = Vdot_f / V * (Xfaf / 1000 - Xfa / 1000) + Y_fa * R7 - R15 + 1.65554 "Fatty acids";
    ...
    der(Xac / 1000) = (Vdot_f / V * (Xacf / 1000 - Xac / 1000) + Y_ac * R11 - R18)+3.31 "Acetate";
//  Xac = 12000;
...
//CO2
  ...
  model AD2_CO2
    ...
    parameter Real K_S_pro = 100 "g DQO_s/m3";
    parameter Real K_I_h2_pro = 0.0035 "g DQO/m3";
    parameter Real k_m_ac = 0.35 "g DQO_s/g DQO_x day";
    parameter Real K_S_ac = 150 "g DQO_s/m3";
    parameter Real K_I_nh3 = 1.8 "g DQO/m3";
    parameter Real k_m_h2 = 100 "g DQO_s/g DQO_x day";
    parameter Real K_S_h2 = 0.0000000001 "g DQO_s/m3";
    parameter Real k_dec_xsu = 0.02 "day^-1";
    parameter Real k_dec_xaa = 0.02 "day^-1";
    parameter Real k_dec_xfa = 0.02 "day^-1";
    parameter Real k_dec_xc4 = 0.02 "day^-1";
    ...
    parameter Real V = 21 "Volume reactor m3";
    parameter Real b0 = 0.25;
    parameter Real S_IN = 0.01 "g/m3";  
    parameter Real Snh3 = 0 "g/m3";
    parameter Real Hh2 = 10.8 "Lower heating value MJ/m3";
  ...
  //  parameter Real PPump(unit="Kw") = 30 "Pump power";
    ...
    Real Xch4;
    Real Xpro;
    Real Xac(start = 24000, fixed = true);
...
// Particulate fraction
    ...
    der(Xsu / 1000) = Vdot_f / V * (Xsuf - Xsu) / 1000 + Y_su * R5 - R13 "Sugars";
...
//  Xch4 = 1000;
    ...
    der(Xac) = Vdot_f / V * (Xacf - Xac) + Y_ac * R11 - R18 "Acetate";
//  Xac = 25000;
    der(Xh2) = Vdot_f / V * (Xh2f - Xh2) + Y_h2 * R12 - R19 + 700 "Hydrogen";
//  Xh2 = 25000;
...
//CO2
  ...
  model PHA_CO2
    ...
    parameter Real Cp = 4186 "specific heat of water";
    parameter Real DT = 5 "Temperature variation";
    parameter Real F = 0.8 "Filled reactor volume";
    parameter Real EHS = 0.45 "Efficient of heating system";
...
////Chemical cost
  ...
  class MAIN
    ...
    parameter Real Vaf = 5.36;
    parameter Real Vad = 21;
    parameter Real Var = 1.70;
  ...
  //INTRODUCE COMPOSITION
    ...
    AFTERLIFE.Source Wastewater annotation(
      Placement(visible = true, transformation(origin = {-124, 44}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    ...
    AFTERLIFE.AD_CO2 AnaerobicFermentation(V = Vaf) annotation(
      Placement(visible = true, transformation(origin = {-78, 42}, extent = {{-14, -14}, {14, 14}}, rotation = 0)));
    ...
    AFTERLIFE.MicrofilterA CeramicFilter annotation(
    ...
    AFTERLIFE.AD2_CO2 AnaerobicDigestion(V = Vad) annotation(
      Placement(visible = true, transformation(origin = {-51, -21}, extent = {{-15, -15}, {15, 15}}, rotation = 0)));
    AFTERLIFE.sensor_O2 sensor_O21 annotation(
      Placement(visible = true, transformation(origin = {12, 67}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
    Modelica.Blocks.Sources.Step step1(height = 1.5) annotation(
      Placement(visible = true, transformation(origin = {-6, 55}, extent = {{-4, -4}, {4, 4}}, rotation = 0)));
    Modelica.Blocks.Math.Feedback feedback1 annotation(
      Placement(visible = true, transformation(origin = {13, 50}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
    Modelica.Blocks.Continuous.PI PI(T = 0.001, k = 500) annotation(
      Placement(visible = true, transformation(origin = {28, 50}, extent = {{-4, -4}, {4, 4}}, rotation = 0)));
    AFTERLIFE.blower blower1 annotation(
      Placement(visible = true, transformation(origin = {-7, 18}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
    Modelica.Blocks.Sources.Constant const(k = 15) annotation(
      Placement(visible = true, transformation(origin = {11, 19}, extent = {{-4, -4}, {4, 4}}, rotation = 0)));
    ...
    AFTERLIFE.PHAStorage pHAStorage1 annotation(
      Placement(visible = true, transformation(origin = {122, -22}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    ...
    AFTERLIFE.UltrafilterA ultrafilterA1 annotation(
      Placement(visible = true, transformation(origin = {-31, 37}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
    AFTERLIFE.mixer2 mixer22 annotation(
      Placement(visible = true, transformation(origin = {36, 40}, extent = {{-4, -4}, {4, 4}}, rotation = 0)));
    AFTERLIFE.mixer2 mixer23 annotation(
      Placement(visible = true, transformation(origin = {-18, 34}, extent = {{-4, -4}, {4, 4}}, rotation = 0)));
  ...
  equation
    connect(const.y, PHA.T) annotation(
      Line(points = {{15, 19}, {15, 19.5}, {11.4, 19.5}, {11.4, 20}, {1.65, 20}, {1.65, 0}, {0, 0}}, color = {0, 0, 255}));
    connect(step1.y, feedback1.u1) annotation(
      Line(points = {{-2, 55}, {-2, 50.25}, {4.4, 50.25}, {4.4, 49.5}, {6.8, 49.5}, {6.8, 50}, {9.4, 50}}, color = {0, 0, 255}));
    connect(sensor_O21.So, feedback1.u2) annotation(
      Line(points = {{19, 67}, {19, 35.5}, {12.86, 35.5}, {12.86, 46}}));
    connect(sensor_O21.In, PHA.MeasurePort) annotation(
      Line(points = {{12, 60}, {12, 43}, {17.5, 43}, {17.5, 43.75}, {19.5, 43.75}, {19.5, 44.125}, {11.5, 44.125}, {11.5, 48.5}}));
    connect(mixer23.In1, Mineralmedium.Out) annotation(
      Line(points = {{-22, 35}, {-21.1, 35}, {-21.1, 85}, {-49, 85}}));
    connect(PHA.In, mixer23.Out) annotation(
      Line(points = {{-3, 44}, {-6.5, 44}, {-6.5, 34}, {-14, 34}}));
    connect(mixer23.In2, ultrafilterA1.Out2) annotation(
      Line(points = {{-22, 34}, {-24.25, 34}, {-24.25, 17.4}, {-28.5, 17.4}, {-28.5, 16.4}, {-27.375, 16.4}, {-27.375, 35}, {-25, 35}}));
    connect(mixer31.In1, ultrafilterA1.Out1) annotation(
      Line(points = {{-88, -20.6}, {-90.25, -20.6}, {-90.25, -18.6}, {-146.5, -18.6}, {-146.5, 60.4}, {-27.375, 60.4}, {-27.375, 40}, {-25, 40}}));
    connect(ultrafilterA1.In, CeramicFilter.Out2) annotation(
      Line(points = {{-37, 40}, {-44, 40}}));
    connect(AnaerobicFermentation.In, Wastewater.Out) annotation(
      Line(points = {{-82, 42}, {-68, 42}, {-68, 39}, {-115, 39}}));
    connect(PureWater.In, reverseOsmosisA1.Out2) annotation(
      Line(points = {{56, -69.2}, {56, -50.6}, {58, -50.6}, {58, -32}}));
    connect(reverseOsmosisA1.In, CartridgeFilter.Out2) annotation(
      Line(points = {{42, -26}, {42, -8.6}, {70, -8.6}, {70, 34.4}}));
    connect(Recirculation.In, reverseOsmosisA1.Out1) annotation(
      Line(points = {{78, -29}, {78, -29.52}, {64.56, -29.52}, {64.56, -27.52}, {52.56, -27.52}, {52.56, -27.27}, {50.56, -27.27}, {50.56, -25.395}, {58, -25.395}, {58, -26}}));
    connect(CeramicFilter.In1, AnaerobicFermentation.Out) annotation(
      Line(points = {{-60, 46}, {-60, 38.5}, {-64, 38.5}, {-64, 42}}));
    connect(mixer31.In2, CeramicFilter.Out1) annotation(
      Line(points = {{-87.72, -21.76}, {-87.72, -24.7213}, {-85.3, -24.7213}, {-85.3, -22.6851}, {-101.3, -22.6851}, {-101.3, 24.35}, {-100.8, 24.35}, {-100.8, 29.139}, {-44, 29.139}, {-44, 46}}));
    connect(blower1.AirOut, PHA.AirIn) annotation(
      Line(points = {{-7.7, 25}, {-7.7, 28.25}, {-3.1, 28.25}, {-3.1, 35.5}, {6, 35.5}}));
    connect(mixer22.In1, PHA.Out) annotation(
      Line(points = {{32, 41.4}, {34.5, 41.4}, {34.5, 44}, {16, 44}}));
    connect(CartridgeFilter.In1, mixer22.Out) annotation(
      Line(points = {{54, 40.4}, {40, 40.4}}));
    connect(mixer22.In2, centrifuge.Effluent) annotation(
      Line(points = {{32.28, 40.24}, {32.28, 5.24}, {65.28, 5.24}, {65.28, 5.24}, {98.28, 5.24}}));
    connect(pHAStorage1.In, centrifuge.Solids) annotation(
      Line(points = {{112, -23.2}, {112, -7.7}, {112, -7.7}, {112, 9.8}, {107.75, 9.8}, {107.75, 9.8}, {105.625, 9.8}, {105.625, 9.8}, {103.5, 9.8}}));
    connect(centrifuge.In, extractor.Effluent) annotation(
      Line(points = {{98, 10}, {98, 28.75}, {100, 28.75}, {100, 47.5}, {95, 47.5}, {95, 44}}));
    connect(extractor.In, CartridgeFilter.Out1) annotation(
      Line(points = {{84.5, 43.9}, {84.5, 36.2}, {68.5, 36.2}, {68.5, 34.2}, {61.5, 34.2}, {61.5, 39.9}, {65.75, 39.9}, {65.75, 39.9}, {70, 39.9}}));
    connect(AnaerobicDigestion.In, mixer31.Out) annotation(
      Line(points = {{-66, -21}, {-66, -22.5}, {-80, -22.5}, {-80, -22.25}, {-80, -22.25}, {-80, -22}}));
    connect(LiquidFertiliser.In, recovery2.Effluent) annotation(
      Line(points = {{-34, -77.2}, {-34, -73.325}, {-32, -73.325}, {-32, -69.45}, {-34, -69.45}, {-34, -61.7}, {-39.25, -61.7}, {-39.25, -61.7}, {-43.875, -61.7}, {-43.875, -61.7}, {-46.1875, -61.7}, {-46.1875, -61.7}, {-48.5, -61.7}}));
    connect(BiogasII.In, recovery2.GasPhase) annotation(
      Line(points = {{-12, -47.2}, {-12, -47.825}, {-12, -47.825}, {-12, -46.45}, {-10, -46.45}, {-10, -45.7}, {-24.25, -45.7}, {-24.25, -45.7}, {-33.375, -45.7}, {-33.375, -45.7}, {-36.9375, -45.7}, {-36.9375, -45.7}, {-40.5, -45.7}}));
    connect(SolidManure.In, recovery2.Waste) annotation(
      Line(points = {{-98, -79.2}, {-98, -74.825}, {-96, -74.825}, {-96, -70.45}, {-98, -70.45}, {-98, -61.7}, {-72.75, -61.7}, {-72.75, -61.7}, {-62.125, -61.7}, {-62.125, -61.7}, {-51.5, -61.7}}));
    connect(recovery2.In, AnaerobicDigestion.Out) annotation(
      Line(points = {{-60, -51}, {-65.5, -51}, {-65.5, -51}, {-71, -51}, {-71, -39}, {-24.5, -39}, {-24.5, -21}, {-30.25, -21}, {-30.25, -21}, {-36, -21}}));
    connect(PI.y, blower1.u) annotation(
      Line(points = {{32.4, 50}, {32.4, 49.3438}, {32.4, 49.3438}, {32.4, 48.6875}, {34.4, 48.6875}, {34.4, 44.75}, {26.4, 44.75}, {26.4, 29}, {0.399997, 29}, {0.399997, 19.25}, {-3.05176e-06, 19.25}, {-3.05176e-06, 16}}));
    connect(feedback1.y, PI.u) annotation(
      Line(points = {{17.5, 50}, {23, 50}}));
