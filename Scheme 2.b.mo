...
// ratios of soluble components
    ...
    (Effluent.Q + Waste.Q) * abs(S) = (-In.Q) * Sf;
// gas flow
    GasPhase.Xc = 0;
    GasPhase.Xch = 0;
    GasPhase.Xpr = 0;
...
Storage or further sludge treatment is not jet considered."));
  ...
  protected
    ...
    //fixed
    parameter Real[n] a = {0.0014, 0.005, 0.003, 2.04, 8.2, 0.65};
...
//der(1 / q4) = Rm * Vis / (PTm * A) * (Kc * q4 * Xsf * Vis / (2 * PTm * A ^ 2));
  ...
  model AD_CO2
    ...
    parameter Real k_m_aa = 5000 "g DQO_s/g DQO_x day";
    parameter Real K_S_aa = 300 "g DQO_s/m3";
    parameter Real k_m_fa = 0.6 "g DQO_s/g DQO_x day";
    parameter Real K_S_fa = 50 "g DQO_s/m3";
    ...
    parameter Real k_m_pro = 9 "g DQO_s/g DQO_x day";
    ...
    parameter Real f_fa_li = 3.29 "g DQO_fa/g DQO_li";
    parameter Real f_va_aa = 2.99 "g DQO_va/g DQO_aa";
    parameter Real f_bu_su = 2.99 "g DQO_bu/g DQO_su";
    parameter Real f_bu_aa = 2.99 "g DQO_bu/g DQO_aa";
    parameter Real f_pro_aa = 3.29 "g DQO_pro/g DQO_aa";
    parameter Real f_ac_su = 2.99 "g DQO_ac/g DQO_su";
    parameter Real f_ac_aa = 3.29 "g DQO_ac/g DQO_aa";
...
//CO2
  ...
  model AD2_CO2
    ...
    parameter Real K_S_pro = 100 "g DQO_s/m3";
    parameter Real K_I_h2_pro = 0.0035 "g DQO/m3";
    parameter Real k_m_ac = 20 "g DQO_s/g DQO_x day";
...
//der(1 / q4) = Rm * Vis / (PTm * A) * (Kc * q4 * Xsf * Vis / (2 * PTm * A ^ 2));
  ...
  //INTRODUCE COMPOSITION
    ...
    AFTERLIFE.MicrofilterA Microfilter(A = Am) annotation(
      Placement(visible = true, transformation(origin = {-178, -76}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    ...
    AFTERLIFE.mixer3 mixer31 annotation(
      Placement(visible = true, transformation(origin = {-236, 88}, extent = {{-6, -6}, {6, 6}}, rotation = 0)));
    ...
    AFTERLIFE.MicrofilterFOG microfilterFOG1 annotation(
      Placement(visible = true, transformation(origin = {-153, -31}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
    AFTERLIFE.Settler settler2 annotation(
      Placement(visible = true, transformation(origin = {58, -20}, extent = {{-6, -6}, {6, 6}}, rotation = 0)));
    AFTERLIFE.mixer2 mixer22 annotation(
      Placement(visible = true, transformation(origin = {8, -26}, extent = {{-4, -4}, {4, 4}}, rotation = 0)));
    ...
    AFTERLIFE.mixer2 mixer23 annotation(
      Placement(visible = true, transformation(origin = {80, -26}, extent = {{-4, -4}, {4, 4}}, rotation = 0)));
    ...
    AFTERLIFE.mixer2 mixer24 annotation(
      Placement(visible = true, transformation(origin = {-203, -73}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
